...
use App\Z\Routing\RouteInterface;
    ...
    class Route implements RouteInterface {
         ...
         * L'uri de la route, c'est le chemin (path) de la route dont l'application attend la réception @return string */
         ...
         * avec lesquels l'on peut accéder à la route @return array */
